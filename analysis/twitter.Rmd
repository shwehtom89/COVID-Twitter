...
params:
  ...
  snapshot_name: "quotes"
  # name of the directory in which snapshots are located.
  snapshot_path: "/home/shweht/DARL-2020/COVID-Twitter/analysis/snapshots/"
---
...
###############################################################################
if (!snapshot_loaded) {
  resultfields <- '"id_str", "created_at", "user.screen_name", "user.verified", "user.location", "place.full_name", "place.country", "text", "full_text", "extended_tweet.full_text", "embedding.use_large.primary", "quoted_status.text"'
  ...
  required_fields <- c("full_text", "id_str", "created_at", "user_screen_name", "user_verified", "user_location", "place.country", "place.full_name", "sentiment", "quoted_status.text")
